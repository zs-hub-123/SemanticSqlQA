    ...
    <div class="dataset-list">
      ...
      >
        ...
        <div class="dataset-badge" v-if="ds.stats">
          <span class="badge" :class="getBadgeClass(ds.stats.sql_generation_accuracy)">
            {{ ds.stats.sql_generation_accuracy }}%
          </span>
        </div>
      </div>
    </div>
...
function getBadgeClass(accuracy) {
  if (accuracy === undefined || accuracy === null) return 'badge-default'
