        ...
        <div class="sql-grid">
          ...
          <div class="sql-card ai-sql">
            <div class="sql-header">
              ...
              <span v-if="resultData.ai_sql_match === true" class="match-badge match-success">匹配</span>
              <span v-else-if="resultData.ai_sql_match === false" class="match-badge match-fail">不匹配</span>
            </div>
...
import { getQuestionDetail, generateAiSql, executeSql } from './api.js'
...
async function generateAi() {
  ...
  try {
    ...
    if (res.data.success) {
      ...
      resultData.value.ai_sql_match = res.data.sql_match
      if (res.data.error) {
